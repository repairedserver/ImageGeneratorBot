...
설정을 끝내고 봇 아래의 View Token이나 Reset Token으로 봇 토큰을 복사한 뒤 DiscordBot.py에 사용할 봇의 토큰을 복붙해주세요. </br> </br>
좌측 OAuth2 카테고리의 URL Generator에 들어가 bot을 선택해 준 뒤 아까와 같이 선택해 주고 링크를 브라우저 창에 복붙해 서버에 봇을 초대해주세요. </br>
