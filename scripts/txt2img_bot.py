...
class SDBot:
    def __init__(self):
        ...
        self.outpath = r"C:\Users\dnjfd\Downloads\stable-diffusion-main\stable-diffusion-main\outputs\txt2img-samples"
        self.sample_path = os.path.join(self.outpath, "samples")
        self.img_path = r'C:\Users\dnjfd\Downloads\stable-diffusion-main\stable-diffusion-main\outputs\txt2img-samples'
